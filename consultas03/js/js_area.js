...
function draw_chart() {
    ...
    var options = {
        ...
        hAxis: {
            title: 'Tiempo para iniciar acciones',
        ...
        vAxis: {
            ...
            //gridlines: {color: '#ffaa33', count: 4},
            //ormat: '#,##%'
        },
        annotations: {
            style: 'out',
    ...
    $("#titulo_categoria").html('Grado de Intervención');
    //$("#div_categoria").show();
}

function draw_map() {
    $.ajax({
        url: "/consultas03/AreasCriticas/consultar",
        type: "POST",
        data: $("#insertForm").serialize(),
        async: false,
