<html>
    <head>
        ...
        <script src="<?php echo base_url() ?>js/js_vulnerabilidad.js"></script>
            ...
            <div id="wrap">
                <div id="content" class="block" style="width: 690px;">
                    <div class="block_head">
                        ...
                        <h2>Áreas Vulnerables por Unidad Hídrica</h2>
                    </div>

                    <div id="block_content" class="block_content">
                        <p style="width: 650px;">El reporte que se presenta a continuación expone las áreas vulnerables frente a la amenaza climática (movimientos en masa, inudaciones y sequías) de cada unidad hídrica objeto de estudio</p>
                        ...
                        <hr>
                        <h4 style="text-align: center;"><label>Áreas Críticas - Vulnerabilidad </label></h4>
                        <?php
                        $form_data = array('id' => 'insertForm',
                            "onsubmit" => "consultar_datos(); return false;");
                        echo form_open(base_url() . 'Vulnerabilidad/grafica/', $form_data);
                        ?>
                        ...
                        <div id="div_amenaza" style="height: 240px">
                            ...
                            <img src="<?php echo base_url() ?>images/area/vulnerabilidad.PNG" style="height: 200px" >
