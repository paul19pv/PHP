<html>
    ...
    <body>
        <div id="hld" style="min-height: 500px;">
            <div id="wrap">
                <div id="content" class="block">
                    <div class="block_head">
                        <div class="bheadl"></div>
                        <div class="bheadr"></div>
                        <h2>Por Caudal Concesionado</h2>
                    </div>
                    <div id="block_content" class="block_content">
                        <p style="width: 650px;">El reporte que se presenta a continuación muestra los caudales de las concesiones registradas en el área de estudio, organizadas por provincia, cantón y parroquia</p>
                        
                        
                        
                        <?php
                        $form_data = array('id' => 'insertForm',
                            "onsubmit" => "informacion_caudal(); return false;");
                        echo form_open('concesion2008/informacion_caudal', $form_data);
                        ?>
