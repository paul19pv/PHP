...
//$form_data = array('id' => 'insertFormMedida');
    echo form_open('medida/modificar_gestion/ejecutor/'.$med_id, $form_eje);
                ...
                <tr class="rows" style="font-size: 11px;">
                    <td style="font-size: 11px;">
                        <div class="checkboxFour">
                            ...
                            if (count($item) > 5) {
                                ?>
                                <input type="checkbox" name="ejecutor[]" checked="" id="<?php echo $i; ?>" value="<?php echo $item['act_id'] ?>">
                                <?php
                            } else {
                                ?>
...
//$form_data = array('id' => 'insertFormMedida');
    echo form_open('medida/modificar_gestion/beneficiario/'.$med_id, $form_ben);
                ...
                <tr class="rows" style="font-size: 11px;">
                    <td style="font-size: 11px;">
                        <div class="checkboxFour">
                            ...
                            if (count($item) > 5) {
                                ?>
                                <input type="checkbox" name="beneficiario[]" checked="" id="<?php echo "ben" . $i; ?>" value="<?php echo $item['act_id'] ?>">
...
//$form_data = array('id' => 'insertFormMedida');
    echo form_open('medida/modificar_gestion/aliado/'.$med_id, $form_ali);
                ...
                <tr class="rows" style="font-size: 11px;">
                    <td style="font-size: 11px;">
                        <div class="checkboxFour">
                            ...
                            if (count($item) > 5) {
                                ?>
                                <input type="checkbox" name="aliado[]" checked="" id="<?php echo "ali" . $i; ?>" value="<?php echo $item['act_id'] ?>">
...
//$form_data = array('id' => 'insertFormMedida');
    echo form_open('medida/modificar_gestion/responsable/'.$med_id, $form_res);
                ...
                <tr class="rows" style="font-size: 11px;">
                    <td style="font-size: 11px;">
                        <div class="checkboxFour">
                            ...
                            if (count($item) > 5) {
                                ?>
                                <input type="radio" name="responsable[]" checked="" id="<?php echo "res" . $i; ?>" value="<?php echo $item['act_id'] ?>">    
                                <?php
                            } else {
                                ?>
...
<script>
    ...
    /*
    function clasificar_vista_plazo(med_id) {
        $.ajax({
            url: "medida/clasificar_vista_plazo/" + med_id,
            //url: "medida/view_modificar_ubicacion/1",
            type: "POST",
            //data: $("#insertFormMedida").serialize(),
            success: function(datos) {
