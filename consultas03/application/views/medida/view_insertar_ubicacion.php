...
<div class="block_form">
    ...
    echo form_open('medida/guardar_ubicacion', $form_data);
    ...
    <div style="float:left; width:290px">
        ...
        <?php
        $val_foto = set_value('ubi_foto');
        if ($val_foto === "") {
            ?>
            <p id="p_foto">
                <label>Foto:</label><br>
                <?php
                echo form_error('ubi_foto');
            ...
            ?>
            <p id="p_foto">
                <label>Foto:</label><br></p>

            <div class="error" style="color:#555">Archivo Cargado</div>
        ...
        <?php
        $val_croquis = set_value('ubi_croquis');
        if ($val_croquis === "") {
            ?>
            <p id="p_croquis" >
                <label>Croquis:</label><br>
                <?php
                echo form_error('ubi_croquis');
