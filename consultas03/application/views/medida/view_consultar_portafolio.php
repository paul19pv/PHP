            ...
            <div id="wrap">
                <div id="content" class="block" style="width: 690px;">
                    <div class="block_head">
                        ...
                        <h2>Portafolio de Medidas por Unidad Hídrica</h2>
                    </div>


                    <div id="block_content" class="block_content">
                        <p style="width: 650px;">Las medidas que se presentan a continuación representan las actividades que se pueden realizar frente a la amenaza climática (movimientos en masa, inundaciones y sequías) con el fin de afrontar un posible impacto del cambio climático.</p>
                        ...
                        <hr>
                        <h4 style="text-align: center;"><label>Portafolio de Medidas de Adaptación</label></h4>

                        <?php
                        $form_data = array('id' => 'searchMedida', "onsubmit" => "return false;");
                        echo form_open('medida/consultar_portafolio_medida/', $form_data);
                        ?>
