...
<div class="block_form">
    ...
    <div style="float:left; width:290px">
        ...
        <p>
            <label>C2:Importancia por los  beneificios directos a población</label><br />
            <?php echo form_error('pri_c3'); ?>
            <?php
            $c2_data = array('id' => 'pri_c2',
                'name' => 'pri_c2',
                'class' => 'both small',
                'value' => set_value('pri_c2'),
