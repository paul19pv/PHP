...
class Concesion2008 extends CI_Controller {
    ...
    public function informacion_caudal() {
        ...
        $this->load->view('concesion2008/consultar_caudal', $data);
    }
