...
class Red2011 extends CI_Controller {
    ...
    public function view_consulta($variable) {
        $data['estaciones'] = $this->red2011->consultar_estaciones($variable);
    ...
    public function cargar_periodo() {
        if ($this->input->post('estacion')) {
            ...
            $periodo = $this->red2011->periodo($estacion, $variable);
    ...
    public function consultar_informacion() {
        ...
        $data['informacion'] = $this->red2011->consultar_informacion($valores);
    ...
    public function formar_titulo($valores) {
        $data_medicion = $this->red2011->consultar_medicion($valores);
    ...
    public function formar_fila_completa($valores) {
        $informacion = $this->red2011->consultar_informacion($valores);
